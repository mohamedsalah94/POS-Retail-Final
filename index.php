...
<head>
    ...
    <meta name="theme-color" content="#618DFF">
    ...
    <!-- main css file -->
    <link rel="stylesheet" href="assets/css/style.css?v=<?php echo $config['v']; ?>" />
        ...
        <div class="container-fluid">
            <div class="row">
                ...
                <div class="col-lg-8 col-md-12">
                    <!-- Start Input -->
                    <div class="col-lg-12 d-flex justify-content-between all-search-inputs">
                        <div class="col-lg-7 col-md-6  col-sm-10 col-10 p-0 mr-sm-3 mr-2 all-search-input">
                        ...
                        <div class="col-lg-5 col-md-4 d-lg-block d-md-block d-sm-none d-none p-0">
                            <div class="select-branch my-3 mr-4">
                        ...
                        <div class="d-lg-none col-md-1 col-sm-2 col-2 cart-button-cart">
                            <div class="shopping-card  my-3 ml-md-2 text-right">
                    ...
                    <!-- End Input -->
                    <!-- Start Category -->
                    <div class="col-12 all-categories-card">
                    ...
                    <!-- End Category -->
                    <!-- Start Products -->
                    <div class="col-12 all-products-card">
                ...
                <div class="col lg-4  p-0 overlay">
                    <div class="product-sidebar py-3 position-relative ">
                        <div class="add-customer">
                            <div class="input-search search-products d-flex mx-3">
                            ...
                            <h6 class="order-number my-2 px-3">Order Num : #2566877</h6>
                        </div>
                        ...
                        <div class="promo py-2 px-3">
                            ...
                            <input type="checkbox" class="option-input promo-input radio check-button discount-check" name="discount"  >
              ...
              <div class="modal-content">
                  <div class="modal-header border-0 p-0">
                      <div class="img-special-product m-auto">
                          ...
                          <img src="assets/img/products/Mask Group 1@2x.png" class="d-lg-inline-block d-md-inline-block d-sm-inline-block d-none" alt="">
                      </div>
                  </div>
                  ...
                  <div class="products-colors d-flex justify-content-between ">
                      <div class="name-color">
                          <h6>Color</h6>
                      </div>
                     
                      <div class="colors-check d-flex align-items-center">
                          <div class="all-colors mr-lg-3 ml-lg-1 mr-md-3 ml-md-1 mr-4 ml-2">
                          ...
                          <div class="all-colors mr-lg-4 ml-lg-3 mr-md-4 ml-md-4 mr-5 ml-2">
                              <label for=" " class="salary-head  pr-1 ">5$</label>
                              <input type="radio" class="product-red-color all-color-buttons radio check-color-button " name="colors" value="red">
                          </div>
                          <div class="all-colors mr-lg-5 ml-lg-3 mr-md-5 ml-md-3 mr-5 ml-0">
                              <label for=" " class="salary-head  pr-1 ">5$</label>
                  ...
                  <div class="products-colors d-flex justify-content-between  m-0" style=" height: 20%;">
                      <div class="name-size">
                          <h6>Size</h6>
                      </div>
